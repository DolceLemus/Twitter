...
buttonTweet.addEventListener('click', function() {
    // creando objetos
    var container = document.getElementById('container');
    var valForm = document.getElementById('form').value;
    var textForm = document.createTextNode(valForm);
    var paragraphForm = document.createElement('p');
    var containerTweet = document.createElement('div');

    // anidando elementos
    container.appendChild(containerTweet);
    containerTweet.appendChild(paragraphForm);
    paragraphForm.appendChild(textForm);
